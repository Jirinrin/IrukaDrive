			...
			foreach( ( int fillType, string fillSuffix ) in fillTypes ) {
				...
				switch( fillType ) {
					case ShapeFill.FILL_NONE:
						...
						g += new CombinatorialParams( "PolygonTriangulation triangulation", "Color color" );
						break;
					case FILL_CUSTOM:
						g += new CombinatorialParams( "PolygonTriangulation triangulation", "ShapeFill fill" );
						break;
					case (int)FillType.LinearGradient:
						...
						g.constAssigns["fill"] = "ShapeFill.CreateLinear( start, end, colorStart, colorEnd, fillSpace )";
						break;
					case (int)FillType.RadialGradient:
						...
						g += "Color colorEnd";
						g += new Param( "FillSpace fillSpace" ) { methodSigDefault = "FillSpace.Local" };
						g.constAssigns["fill"] = "ShapeFill.CreateRadial( origin, radius, colorStart, colorEnd, fillSpace )";
						break;
					default:
